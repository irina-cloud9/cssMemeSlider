...
console.log(
  "Десктопная версия - 1024.\nМобильная версия – 768.\nПри переключении десктопной версии на мобильную ( и в обратную сторону) необходимо перезагрузить стираницу!!!\nИ при изменении разрешения ширины экрана нужно перезагружать страницу"
);
